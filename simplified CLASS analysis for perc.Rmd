...
ggplot(data=for_plot[for_plot$race!="Other",], aes(x=race, y=Q, group=gender_time, color=gender, shape=Time)) + geom_point(position = position_dodge(width=0.90), size=3) + geom_errorbar(aes( ymax= Q+SE, ymin=Q-SE), position="dodge")+
